...
namespace NewTemplateManager.Application.CQRS
{
    public  class CreateModelVersionDocumentCommandHandler  :  IRequestHandler<CreateModelVersionDocumentCommand, Either<GeneralFailure, Guid>>
    {
        ...
        }//var entity =null; Domain.Entities.ModelVersionDocument.Create(request.modelVersionDocumentCreateDTO.ModelVersionDocumentName, request.modelVersionDocumentCreateDTO.Value.GuidId);return ( await _unitOfWork.ModelVersionDocumentRepository.AddAsync(entity, cancellationToken)). Map((x) =>  entity.GuidId);
    }
}