...
namespace NewTemplateManager.Application.CQRS
{
    public  class CreateTestPointCommandHandler  :  IRequestHandler<CreateTestPointCommand, Either<GeneralFailure, Guid>>
    {
        ...
        }//var entity =null; Domain.Entities.TestPoint.Create(request.testPointCreateDTO.TestPointName, request.testPointCreateDTO.Value.GuidId);return ( await _unitOfWork.TestPointRepository.AddAsync(entity, cancellationToken)). Map((x) =>  entity.GuidId);
    }
}