...
namespace NewTemplateManager.Infrastructure.Maps
{
    public static class Mapper
    {
        ...
        //public static Domain.ModelAggregateRoot.Entities.ModelType ToEntity(this NewTemplateManager.Infrastructure.Persistence.Repositories.Models.ModelType model)
