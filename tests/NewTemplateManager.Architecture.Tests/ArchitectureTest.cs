...
namespace NewTemplateManager.Architecture.Tests
{
    public class ArchitectureTest
    {
        public class ArchitectuteTest
        {
            ...
            private const string DomainNamesspace = "NewTemplateManager.Domain";
            private const string InfrastructureNamespace = "NewTemplateManager.Infrastructure";
            private const string ApplicationNamespace = "NewTemplateManager.Application";
            private const string Presentation = "NewTemplateManager.Api";
            private const string Contract = "NewTemplateManager.Contracts";
            private const string DomainBaseNamesspace = "NewTemplateManager.DomainBase";
            private const string BaseModels = "NewTemplateManager.BaseModels";
